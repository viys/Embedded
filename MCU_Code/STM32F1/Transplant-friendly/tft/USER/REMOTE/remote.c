...
void TIM4_IRQHandler(void)
{
	...
	if(remflag&0x40)
	{
		...
		switch (t1)
        {
        	case REMOTE_1:Relays_State_Config(RELAYS1,RELAYS_ON);printf("remote_1\r\n");
        		break;
			case REMOTE_RIGHT:;
        		break;
			case REMOTE_LEFT:;
        		break;
			case REMOTE_OK:Relays_State_Config(RELAYS1,RELAYS_ON);
        		break;
        	default:
        		break;
        }
...
void Remote_Event(void)
{
	...
	if((remote_num=Remote_Scan()) != 0)
	{
		switch (remote_num)
        {
			case REMOTE_0:;
        		break;
        	case REMOTE_1:Relays_State_Config(RELAYS1,RELAYS_ON);printf("Relays_1 is off!!!\r\n");
        		break;
			case REMOTE_2:Relays_State_Config(RELAYS2,RELAYS_ON);printf("Relays_2 is off!!!\r\n");
        		break;
			case REMOTE_3:;
        		break;
			case REMOTE_4:;
			...
			case REMOTE_X:;
				...
				case REMOTE_DOWN:;
        		break;
			case REMOTE_RIGHT:Relays_State_Config(RELAYS1,RELAYS_OFF);printf("Relays_1 is on!!!\r\n");
        		break;
			case REMOTE_LEFT:Relays_State_Config(RELAYS2,RELAYS_OFF);printf("Relays_2 is on!!!\r\n");
        		break;
			case REMOTE_OK:;
        		break;	
        	default:
