...
#define APP_TASK_USART1_PRIO						3
#define APP_TASK_PEND_PRIO							4
#define APP_TASK_POST_PRIO							5
#define APP_TASK_LED1_PRIO							6
#define APP_TASK_LED2_PRIO							7
...
#define APP_TASK_USART1_STK_SIZE 					512
